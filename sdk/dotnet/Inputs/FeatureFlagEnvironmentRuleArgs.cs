...
namespace Pulumi.Launchdarkly.Inputs
{
    ...
    public sealed class FeatureFlagEnvironmentRuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("clauses")]
        private InputList<Inputs.FeatureFlagEnvironmentRuleClauseArgs>? _clauses;

        /// <summary>
        /// List of nested blocks specifying the logical clauses to evaluate
        /// </summary>
        public InputList<Inputs.FeatureFlagEnvironmentRuleClauseArgs> Clauses
        {
            get => _clauses ?? (_clauses = new InputList<Inputs.FeatureFlagEnvironmentRuleClauseArgs>());
            set => _clauses = value;
        }
        ...
        public FeatureFlagEnvironmentRuleArgs()
        {
        }
        public static new FeatureFlagEnvironmentRuleArgs Empty => new FeatureFlagEnvironmentRuleArgs();
    }
}
