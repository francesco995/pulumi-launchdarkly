...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `launchdarkly` with the `NAME` of your provider.
...
├── config.yaml
├── metadata.json
├── pulumi-launchdarkly_darwin_amd64_v1
│   └── pulumi-resource-launchdarkly
├── pulumi-launchdarkly_darwin_arm64
│   └── pulumi-resource-launchdarkly
├── pulumi-launchdarkly_linux_amd64_v1
│   └── pulumi-resource-launchdarkly
├── pulumi-launchdarkly_linux_arm64
│   └── pulumi-resource-launchdarkly
├── pulumi-launchdarkly_windows_amd64_v1
│   └── pulumi-resource-launchdarkly.exe
└── pulumi-launchdarkly_windows_arm64
    └── pulumi-resource-launchdarkly.exe
```
