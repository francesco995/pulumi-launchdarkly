...
class EnvironmentApprovalSetting(dict):
    ...
    def __init__(__self__, *,
                 ...
                 service_config: Optional[Mapping[str, Any]] = None,
    ...
    def service_config(self) -> Optional[Mapping[str, Any]]:
...
class FeatureFlagEnvironmentContextTarget(dict):
    ...
    def __init__(__self__, *,
                 ...
                 variation: int):
        """
        :param str context_kind: The context kind on which the flag should target in this environment. User (`user`) targets should be specified as `targets` attribute blocks.
        :param Sequence[str] values: List of `user` strings to target.
        :param int variation: The index of the variation to serve if a user target value is matched.
        """
...
class FeatureFlagEnvironmentFallthrough(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str context_kind: The context kind associated with the specified rollout. This argument is only valid if rollout_weights is also specified. If omitted, defaults to `user`.
        ...
        :param int variation: The default integer variation index to serve if no `prerequisites`, `target`, or `rules` apply. You must specify either `variation` or `rollout_weights`.
        """
...
class FeatureFlagEnvironmentRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str description: A human-readable description of the targeting rule.
        :param Sequence[int] rollout_weights: List of integer percentage rollout weights (in thousandths of a percent) to apply to each variation if the rule clauses evaluates to `true`. The sum of the `rollout_weights` must equal 100000 and the number of rollout weights specified in the array must match the number of flag variations. You must specify either `variation` or `rollout_weights`.
...
class FeatureFlagVariation(dict):
    def __init__(__self__, *,
        ...
        :param str description: The feature flag's description.
        :param str name: The name of the custom property.
        """
...
class ProjectEnvironmentApprovalSetting(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, Any] service_config: The configuration for the service associated with this approval. This is specific to each approval service. For a `service_kind` of `servicenow`, the following fields apply:
        :param str service_kind: The kind of service associated with this approval. This determines which platform is used for requesting approval. Valid values are `servicenow`, `launchdarkly`.
        """
        if can_apply_declined_changes is not None:
            pulumi.set(__self__, "can_apply_declined_changes", can_apply_declined_changes)
        if can_review_own_request is not None:
...
class SegmentExcludedContext(dict):
    ...
    def __init__(__self__, *,
                 ...
                 values: Sequence[str]):
        """
        :param str context_kind: The context kind associated with this segment target. To target on user contexts, use the included and excluded attributes.
        :param Sequence[str] values: List of target object keys included in or excluded from the segment.
        """
        pulumi.set(__self__, "context_kind", context_kind)
        pulumi.set(__self__, "values", values)
...
class SegmentRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rollout_context_kind: Optional[str] = None,
        ...
        :param str rollout_context_kind: The context kind associated with this segment rule. This argument is only valid if weight is also specified. If omitted, defaults to 'user'
...
class GetEnvironmentApprovalSettingResult(dict):
    ...
    @property
    @pulumi.getter(name="requiredApprovalTags")
    def required_approval_tags(self) -> Sequence[str]:
        return pulumi.get(self, "required_approval_tags")

    @property
    @pulumi.getter(name="serviceConfig")
    def service_config(self) -> Mapping[str, Any]:
        return pulumi.get(self, "service_config")
...
class GetWebhookStatementResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param str effect: Either `allow` or `deny`. This argument defines whether the statement allows or denies access to the named resources and actions.
        :param Sequence[str] actions: The list of action specifiers defining the actions to which the statement applies. For a list of available actions read [Actions reference](https://docs.launchdarkly.com/home/account-security/custom-roles/actions#actions-reference).
        :param Sequence[str] not_actions: The list of action specifiers defining the actions to which the statement does not apply. For a list of available actions read [Actions reference](https://docs.launchdarkly.com/home/account-security/custom-roles/actions#actions-reference).
