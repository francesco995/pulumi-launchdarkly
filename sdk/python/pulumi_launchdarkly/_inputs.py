...
class EnvironmentApprovalSettingArgs:
    def __init__(__self__, *,
                 ...
                 service_config: Optional[pulumi.Input[Mapping[str, Any]]] = None,
    ...
    def service_config(self) -> Optional[pulumi.Input[Mapping[str, Any]]]:
        return pulumi.get(self, "service_config")

    @service_config.setter
    def service_config(self, value: Optional[pulumi.Input[Mapping[str, Any]]]):
        pulumi.set(self, "service_config", value)

    @property
    @pulumi.getter(name="serviceKind")
    def service_kind(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "service_kind")

    @service_kind.setter
    def service_kind(self, value: Optional[pulumi.Input[str]]):
...
class FeatureFlagEnvironmentContextTargetArgs:
    def __init__(__self__, *,
                 context_kind: pulumi.Input[str],
                 values: pulumi.Input[Sequence[pulumi.Input[str]]],
                 variation: pulumi.Input[int]):
        """
        :param pulumi.Input[str] context_kind: The context kind on which the flag should target in this environment. User (`user`) targets should be specified as `targets` attribute blocks.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] values: List of `user` strings to target.
        :param pulumi.Input[int] variation: The index of the variation to serve if a user target value is matched.
        """
    ...
    def context_kind(self) -> pulumi.Input[str]:
        """
    ...
    @context_kind.setter
    def context_kind(self, value: pulumi.Input[str]):
...
class FeatureFlagEnvironmentFallthroughArgs:
    def __init__(__self__, *,
                 ...
                 context_kind: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] context_kind: The context kind associated with the specified rollout. This argument is only valid if rollout_weights is also specified. If omitted, defaults to `user`.
        ...
        :param pulumi.Input[int] variation: The default integer variation index to serve if no `prerequisites`, `target`, or `rules` apply. You must specify either `variation` or `rollout_weights`.
        """
    ...
    @property
    @pulumi.getter(name="contextKind")
    def context_kind(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @context_kind.setter
    def context_kind(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "context_kind", value)
...
class FeatureFlagEnvironmentRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: A human-readable description of the targeting rule.
        :param pulumi.Input[Sequence[pulumi.Input[int]]] rollout_weights: List of integer percentage rollout weights (in thousandths of a percent) to apply to each variation if the rule clauses evaluates to `true`. The sum of the `rollout_weights` must equal 100000 and the number of rollout weights specified in the array must match the number of flag variations. You must specify either `variation` or `rollout_weights`.
...
class ProjectEnvironmentApprovalSettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, Any]] service_config: The configuration for the service associated with this approval. This is specific to each approval service. For a `service_kind` of `servicenow`, the following fields apply:
        :param pulumi.Input[str] service_kind: The kind of service associated with this approval. This determines which platform is used for requesting approval. Valid values are `servicenow`, `launchdarkly`.
        """
        if can_apply_declined_changes is not None:
            pulumi.set(__self__, "can_apply_declined_changes", can_apply_declined_changes)
        if can_review_own_request is not None:
...
class SegmentExcludedContextArgs:
    def __init__(__self__, *,
                 ...
                 values: pulumi.Input[Sequence[pulumi.Input[str]]]):
        """
        :param pulumi.Input[str] context_kind: The context kind associated with this segment target. To target on user contexts, use the included and excluded attributes.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] values: List of target object keys included in or excluded from the segment.
        """
        pulumi.set(__self__, "context_kind", context_kind)
        pulumi.set(__self__, "values", values)
...
class SegmentRuleArgs:
    def __init__(__self__, *,
                 ...
                 rollout_context_kind: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] rollout_context_kind: The context kind associated with this segment rule. This argument is only valid if weight is also specified. If omitted, defaults to 'user'
    ...
    def rollout_context_kind(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def rollout_context_kind(self, value: Optional[pulumi.Input[str]]):
