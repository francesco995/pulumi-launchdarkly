...
class CustomRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] key: A unique key that will be used to reference the custom role in your code
        :param pulumi.Input[str] base_permissions: The base permission level - either reader or no_access. Defaults to reader
        :param pulumi.Input[str] description: Description of the custom role
        :param pulumi.Input[str] name: A name for the custom role
        """
