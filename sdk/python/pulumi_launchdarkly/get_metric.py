...
class GetMetricResult:
    ...
    """
    def __init__(__self__, description=None, event_key=None, id=None, is_active=None, is_numeric=None, key=None, kind=None, maintainer_id=None, name=None, project_key=None, randomization_units=None, selector=None, success_criteria=None, tags=None, unit=None, urls=None):
...
def get_metric(description: Optional[str] = None,
               ...
               randomization_units: Optional[Sequence[str]] = None,
    ...
    __args__['randomizationUnits'] = randomization_units
...
def get_metric_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                      ...
                      randomization_units: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
