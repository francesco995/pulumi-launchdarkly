...
class FeatureFlagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] maintainer_id: The feature flag maintainer's 24 character alphanumeric team member ID. If not set, it will automatically be or stay set
...
class FeatureFlag(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[bool] archived: Specifies whether the flag is archived or not. Note that you cannot create a new flag that is archived, but can update a flag to be archived.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FeatureFlagCustomPropertyArgs']]]] custom_properties: List of nested blocks describing the feature flag's [custom properties](https://docs.launchdarkly.com/home/connecting/custom-properties)
        :param pulumi.Input[pulumi.InputType['FeatureFlagDefaultsArgs']] defaults: A block containing the indices of the variations to be used as the default on and off variations in all new environments. Flag configurations in existing environments will not be changed nor updated if the configuration block is removed.
        :param pulumi.Input[str] description: The feature flag's description.
        :param pulumi.Input[bool] include_in_snippet: Specifies whether this flag should be made available to the client-side JavaScript SDK using the client-side Id. This value gets its default from your project configuration if not set. `include_in_snippet` is now deprecated. Please migrate to `client_side_availability.using_environment_id` to maintain future compatibility.
        :param pulumi.Input[str] key: The unique custom property key.
        :param pulumi.Input[str] maintainer_id: The feature flag maintainer's 24 character alphanumeric team member ID. If not set, it will automatically be or stay set
        ...
        :param pulumi.Input[bool] temporary: Specifies whether the flag is a temporary flag.
        :param pulumi.Input[str] variation_type: The feature flag's variation type: `boolean`, `string`, `number` or `json`.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FeatureFlagVariationArgs']]]] variations: An array of possible variations for the flag
        """
        ...
    @overload
    def __init__(__self__,
