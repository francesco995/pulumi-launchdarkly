...
class FeatureFlagEnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] on: Whether targeting is enabled. Defaults to `false` if not set.
...
class FeatureFlagEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 context_targets: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FeatureFlagEnvironmentContextTargetArgs']]]]] = None,
                 env_key: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FeatureFlagEnvironmentContextTargetArgs']]]] context_targets: The set of nested blocks describing the individual targets for non-user context kinds for each variation.
        :param pulumi.Input[str] env_key: The environment key. A change in this field will force the destruction of the existing resource and the creation of a new one.
        :param pulumi.Input[pulumi.InputType['FeatureFlagEnvironmentFallthroughArgs']] fallthrough: Nested block describing the default variation to serve if no `prerequisites`, `target`, or `rules` apply.
        :param pulumi.Input[str] flag_id: The feature flag's unique `id` in the format `project_key/flag_key`. A change in this field will force the destruction of the existing resource and the creation of a new one.
        :param pulumi.Input[int] off_variation: The index of the variation to serve if targeting is disabled.
        :param pulumi.Input[bool] on: Whether targeting is enabled. Defaults to `false` if not set.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FeatureFlagEnvironmentPrerequisiteArgs']]]] prerequisites: List of nested blocks describing prerequisite feature flags rules.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FeatureFlagEnvironmentRuleArgs']]]] rules: List of logical targeting rules.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FeatureFlagEnvironmentTargetArgs']]]] targets: Set of nested blocks describing the individual user targets for each variation.
        :param pulumi.Input[bool] track_events: Whether to send event data back to LaunchDarkly. Defaults to `false` if not set.
        """
        ...
    @overload
