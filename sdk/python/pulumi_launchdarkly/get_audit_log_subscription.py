...
def get_audit_log_subscription(id: Optional[str] = None,
    ...
    :param str integration_key: The integration key. Supported integration keys are `cloudtrail`, `datadog`, `dynatrace`, `elastic`, `grafana`, `honeycomb`, `logdna`, `msteams`, `new-relic-apm`, `signalfx`, `slack`, and `splunk`.
    """
    __args__ = dict()
    __args__['id'] = id
